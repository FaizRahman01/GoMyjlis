            ...
            <div class="card-body d-flex justify-content-center">
                ...
                <form class="px-2" action="/myevent/{{ $event_id }}/rating" method="post">
                    ...
                    <div class="btn-group mb-3" role="group" aria-label="Basic radio toggle button group">
                        ...
                        <input type="radio" class="btn-check" value="Reasonable" name="content-option" id="btn-content2">
                        <label class="btn btn-outline-dark" for="btn-content2">Reasonable</label>
                        <input type="radio" class="btn-check" value="Satisfied" name="content-option" id="btn-content3">
                    ...
                    <div class="btn-group mb-3" role="group" aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" value="Dissapointed" name="food-option" id="btnfood1">
                        <label class="btn btn-outline-dark" for="btnfood1">Dissapointed</label>
                        <input type="radio" class="btn-check" value="Reasonable" name="food-option" id="btnfood2">
                        <label class="btn btn-outline-dark" for="btnfood2">Reasonable</label>
                        <input type="radio" class="btn-check" value="Satisfied" name="food-option" id="btnfood3">
